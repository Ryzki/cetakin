...
@section('title')Data Pesanan Foto
@endsection
...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Pesanan Foto </li>
  </ol>
</section>
  ...
  <div class="box container">
    <div class="row">
      <div class="col-md-6 col-xs-12">
        <div class="box-header with-border">
          <a href="{{site_url('petugas/pesanan_foto/add')}}" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Tambah Data</a>
        </div>
      </div>
      <div class="col-md-6 col-xs-12">
    ...
    <div class="box-body">
      <table class="table table-hover table-striped">
        ...
        <?php else: ?>
        <?php $start+= 1 ?> @foreach($tampildata as $row)
        <tr>
          <td>{{$start++}}</td>
          ...
          <td>
            <a href="{{site_url('petugas/pesanan_foto/view/'.$row->id)}}" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i> Lihat</a>
          </td>
        </tr>
        @endforeach
        <?php endif ?>
