...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 23, 2018 at 07:38 AM
...
CREATE TABLE `info_harga` (
  ...
  `harga` int(11) NOT NULL,
  `satuan` varchar(45) DEFAULT NULL,
  `status_hapus` enum('0','1') NOT NULL DEFAULT '0' COMMENT '0:tidak bisa dihapus, 1:bisa dihapus',
  `created_at` datetime DEFAULT NULL,
  `created_by` int(11) DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `updated_by` int(11) DEFAULT NULL
...
INSERT INTO `info_harga` (`id`, `idpercetakan`, `idklasifikasi`, `kategori`, `nama`, `harga`, `satuan`, `status_hapus`, `created_at`, `created_by`, `updated_at`, `updated_by`) VALUES
(12, 7, 1, '0', 'A4 Berwarna', 700, 'Lembar', '0', '2018-06-16 17:14:15', 23, '2018-06-16 17:56:36', 23),
(13, 7, 1, '0', 'A4 Hitam Putih', 500, 'Lembar', '0', '2018-06-16 17:31:35', 23, '2018-06-16 17:56:44', 23),
(14, 7, 1, '0', 'F4 Berwarna', 600, 'Lembar', '0', '2018-06-16 17:57:00', 23, NULL, NULL),
(15, 7, 1, '0', 'F4 Hitam Putih', 400, 'Lembar', '0', '2018-06-16 17:58:29', 23, NULL, NULL),
(16, 7, 2, '0', 'Satu', 0, 'Lembar', '0', '2018-06-16 18:00:31', 23, '2018-06-16 18:01:17', 23),
(17, 7, 2, '0', 'Bolak Balik', 200, 'Lembar', '0', '2018-06-16 18:01:08', 23, NULL, NULL),
(18, 7, 3, '0', 'Dijilid', 2500, 'Jilid', '0', '2018-06-16 18:02:54', 23, NULL, NULL),
(19, 7, 3, '0', 'Tidak Dijilid', 0, 'Lembar', '0', '2018-06-16 18:03:17', 23, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `klasifikasi_harga`
--

CREATE TABLE `klasifikasi_harga` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `klasifikasi_harga`
--

INSERT INTO `klasifikasi_harga` (`id`, `nama`, `created_at`, `created_by`, `updated_at`, `updated_by`) VALUES
(1, 'Ukuran Kertas / Jenis Cetak', '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(2, 'Jumlah Sisi', '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(3, 'Jilid', '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0);
...
INSERT INTO `percetakan` (`id`, `nama`, `slug`, `email_percetakan`, `phone_percetakan`, `foto`, `alamat`, `id_provinsi`, `id_kabupaten`, `id_kecamatan`, `status_dokumen`, `status_foto`, `status_percetakan`, `status_verifikasi`, `created_at`, `created_by`, `updated_at`, `updated_by`) VALUES
(7, 'Dimas Printing', 'dimas', 'dimas@gmail.com', '098765', 'CTK_UROFCKSO_20180421104611.jpg', 'Jl. aja terus 01', 35, 3510, 3510130, '1', '1', '1', '1', '2018-04-03 05:22:14', 1, '2018-05-25 05:30:57', 23),
(8, 'Kanissa Print', 'kanissa', 'kanissa@gmail.com', '087633', 'CTK_MLWSQCMT_20180421104626.jpg', 'pakistaji', 0, 0, 3510010, '1', '0', '0', '0', '2018-04-03 05:36:48', 1, '2018-05-24 11:11:10', 1);
...
CREATE TABLE `pesanan_dokumen` (
  `id` int(11) NOT NULL,
  `kode_cetak` varchar(50) NOT NULL,
  `idusers` int(11) UNSIGNED NOT NULL,
  `idpercetakan` int(11) NOT NULL,
  `idjeniscetak` int(11) NOT NULL,
  `idjumlahsisi` int(11) NOT NULL,
  `idstatusjilid` int(11) DEFAULT NULL,
...
INSERT INTO `pesanan_dokumen` (`id`, `kode_cetak`, `idusers`, `idpercetakan`, `idjeniscetak`, `idjumlahsisi`, `idstatusjilid`, `jumlah_copy`, `jumlah_lembar`, `file`, `catatan`, `status`, `catatan_percetakan`, `biaya_cetak`, `created_at`, `created_by`, `updated_at`, `updated_by`) VALUES
(5, 'DOK-001', 12, 7, 1, 1, NULL, 1, 0, 'FL_YGOCLVSY_20180403113202.pdf', 'aaaaaaaaaaaa', '1', '0', 0, '2018-04-03 11:32:02', 12, '2018-05-10 08:07:35', 23),
(6, 'DOK-002', 12, 7, 1, 1, NULL, 50, 0, 'FL_MWCYRCBE_20180403022800.pdf', 'ttytyt', '2', 'ok', 20000, '2018-04-03 14:28:00', 12, '2018-05-10 06:07:12', 23),
(7, 'DOK-003', 12, 7, 1, 1, NULL, 1, 0, 'FL_PTDDLVMJ_20180505051220.docx', 'oke', '2', '0', 0, '2018-05-05 05:12:20', 12, '2018-05-05 06:01:53', 23),
(8, 'DOK-004', 26, 8, 2, 1, NULL, 2, 0, 'FL_IFRRBGWJ_20180505033324.pdf', 'secepatnya ya mas', '0', '0', 0, '2018-05-05 15:33:24', 26, '2018-05-13 10:49:43', 19),
(9, 'DOK-005', 35, 7, 1, 1, NULL, 2, 0, 'FL_JVYZNOFA_20180510112143.docx', 'asd', '2', 'asd', 20000, '2018-05-10 11:21:43', 35, '2018-05-10 11:33:34', 23),
(10, 'DOK-006', 35, 7, 1, 1, NULL, 2, 0, 'FL_TRSWYYKD_20180510120557.pdf', 's', '1', '', 20000, '2018-05-10 12:05:57', 35, '2018-05-10 12:34:52', 23),
(11, 'DOK-007', 12, 8, 1, 2, NULL, 1, 0, 'FL_YIXHNIFT_20180513104059.doc', 'oke sudah', '3', '', 0, '2018-05-13 10:40:59', 12, '2018-05-13 10:45:31', 19),
(12, 'DOK-008', 12, 8, 1, 1, NULL, 1, 0, 'FL_STRHHIED_20180513104403.doc', 'eh oke lagi', '2', 'ambil saja sudah', 20000, '2018-05-13 10:44:03', 12, '2018-05-13 10:45:15', 19),
(13, 'DOK-009', 40, 7, 1, 1, NULL, 1, 0, 'FL_EYTETZXM_20180523110915.docx', 'lorem ipsum', '2', 'sip', 25000, '2018-05-23 11:09:15', 40, '2018-05-23 11:21:41', 23),
(14, 'DOK-010', 40, 7, 12, 16, 18, 1, 1, '', 'asd', '0', '', 0, '2018-06-22 09:45:13', 40, NULL, NULL),
(15, 'DOK-011', 40, 7, 12, 16, 18, 2, 2, '', 'as', '0', '', 0, '2018-06-22 17:02:12', 40, NULL, NULL),
(16, 'DOK-012', 40, 7, 12, 16, 18, 1, 12, 'FL_MQCRMLZZ_20180622050810.docx', 'asd', '0', '', 0, '2018-06-22 17:08:10', 40, NULL, NULL);
...
(1, '', 1, 'admin', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'admin@admin.com', NULL, NULL, NULL, NULL, 0, 1527153057, 1, 'Admin', 'Istrator', 'Admin', '082', 'alamat', NULL, 0, NULL, NULL),
...
(23, '::1', 2, NULL, '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'pdimas2@gmail.com', NULL, NULL, NULL, NULL, 0, 1529316332, 1, 'Dimas Ferian', NULL, NULL, '93453', NULL, '2018-04-21 09:35:46', 1, '2018-04-21 10:58:56', 1),
...
(40, '::1', 3, 'rahmat@labkode.org', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'rahmat@labkode.org', 'e372702a2d253f387a3ce6abaf1523c7cfb2e6bd', NULL, NULL, NULL, 1526630214, 1529730807, 1, 'Rahmat', NULL, NULL, '85735030674', NULL, NULL, 0, NULL, NULL),
...
--
-- Table structure for table `w_kabupaten`
--

CREATE TABLE `w_kabupaten` (
...
--
-- Dumping data for table `w_kabupaten`
--

INSERT INTO `w_kabupaten` (`id`, `province_id`, `name`) VALUES
...
--
-- Table structure for table `w_kecamatan`
--
...
--
-- Dumping data for table `w_kecamatan`
--

INSERT INTO `w_kecamatan` (`id`, `regency_id`, `name`) VALUES
...
--
-- Table structure for table `w_provinsi`
--
...
--
-- Dumping data for table `w_provinsi`
--

INSERT INTO `w_provinsi` (`id`, `name`) VALUES
('11', 'ACEH'),
('12', 'SUMATERA UTARA'),
('13', 'SUMATERA BARAT'),
('14', 'RIAU'),
...
--
-- Indexes for table `klasifikasi_harga`
--
ALTER TABLE `klasifikasi_harga`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `w_kabupaten`
--
ALTER TABLE `w_kabupaten`
  ADD PRIMARY KEY (`id`),
  ADD KEY `regencies_province_id_index` (`province_id`);

--
-- Indexes for table `w_kecamatan`
--
ALTER TABLE `w_kecamatan`
  ADD PRIMARY KEY (`id`),
  ADD KEY `districts_regency_id_index` (`regency_id`);

--
-- Indexes for table `w_provinsi`
--
ALTER TABLE `w_provinsi`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `klasifikasi_harga`
--
ALTER TABLE `klasifikasi_harga`
