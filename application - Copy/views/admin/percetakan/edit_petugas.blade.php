...
@section('content')
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{site_url('admin/percetakan/view/'.$this->uri->segment(5))}}"><i class="fa fa-eye"></i> lihat data</a></li>
    ...
    <section class="content">
      ...
      <a href="{{site_url('admin/percetakan/view/'.$this->uri->segment(5))}}" class="btn btn-info"><i class="fa fa-arrow-left"></i> kembali</a>
      </div>
        <div class="box-body">
          <div class="row">
          ...
          <form class="form-horizontal" action="{{site_url('admin/percetakan/update_petugas/'.$this->uri->segment(4).'/'.$this->uri->segment(5))}}" method="post">
          {{$csrf}}
          {{form_hidden('group_id', '2');}}
          {{form_hidden('percetakan_id', $this->uri->segment(5));}}
          {{form_hidden('id', $this->uri->segment(4));}}
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="password" name="password" class="form-control" value="" id="password" placeholder="Isikan password jika ingin diubah">
              </div>
            </div>
            <div class="form-group">
              <label for="reenter_password" class="col-sm-2 control-label">Konfirmasi Password</label>
              <div class="col-sm-10">
                <input type="password" name="reenter_password" class="form-control" value="" id="reenter_password" placeholder="Konfirmasi Password">
              </div>
            </div>
