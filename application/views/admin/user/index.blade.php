        ...
        <div class="row">
          <div class="col-md-6 col-xs-12">
            <div class="box-header with-border">
              <a href="{{site_url('admin/user/add')}}" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Tambah Data</a>
            </div>
          </div>
          <div class="col-md-6 col-xs-12">
          ...
          <table class="table table-hover table-striped">
                ...
                <?php else: ?>
                    ...
                    <tr>
                      ...
                      <td>{{$row->email}}</td>
                      <td>{{$row->phone}}</td>
                      <td>{{($row->active == '0')?'<span class="label label-default">Belum Aktif</span>':'<span class="label label-primary">Aktif</span>'}}</td>
                      <td>
