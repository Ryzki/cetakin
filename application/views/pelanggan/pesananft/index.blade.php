...
<div class="container-fluid py-4">
  <div class="row">
    ...
    <div class="col-md-9 p-3">
        <h1 style="margin-bottom: -4px" class="text-left display-5">Daftar <b class="text-primary">Cetak Foto</b></h1>
        ...
        <table class="table table-hover">
          ...
          <tbody>
            <tr>
              ...
              <td><a href="{{site_url('pelanggan/pesananft/view/'.$row->id)}}" class="btn btn-primary"><i class="fa fa-fw fa-eye"></i></a></td>
            </tr>
          </tbody>
          @endforeach
          <?php endif ?>
