...
@section('title')Daftar Percetakan
@endsection
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 mb-2 card-hover">
        <div class="card" style="display: flex; cursor: pointer;" onclick="window.location.href='{{site_url('percetakan/detail/'.$value->id.'/'.$this->uri->segment(3).'/'.$value->slug)}}'">
          <div class="row no-gutters">
            <div class="col-md-6">
              <img style="max-width: 265px; max-height: 265px;" class="card-img-top img-fluid img-responsive" src="{{base_url('uploads/percetakan/'.$value->foto)}}"
                width="300" alt="Card image cap">
            </div>
            <div class="col-md-6">
              <div class="card-body">
