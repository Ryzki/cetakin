...
class Pembelian_saldo_model extends MY_Model
{  
	public function __construct()
	{
		...
		$this->has_one['saldo_user'] = array('saldo_user_model','id','id_saldo');
	...
	{ 
		...
		$config['base_url'] = base_url() . 'admin/pembelian_saldo/search/';
